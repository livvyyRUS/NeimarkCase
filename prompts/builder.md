...
5. Создать инструкцию по запуску в файле output/run_instructions.md. В инструкции описать шаги для запуска (путь к исполняемому файлу, необходимые команды).
